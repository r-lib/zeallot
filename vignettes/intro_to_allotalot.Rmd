...
```{r}
minWt : q1Wt : medWt : meanWt : q3Wt : maxWt %<-% summary(mtcars$wt)
minWt
q1Wt
medWt
meanWt
...
an error is raised.
This lets you guard against missing or unexpected values.
...
In this example, the list of values returned by `coordsList()` is unpacked
...
```{r}
minWt : . : . : meanWt : . : maxWt %<-% summary(mtcars$wt)
minWt
meanWt
maxWt
```
