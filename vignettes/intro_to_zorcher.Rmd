...
The *zorcher* package defines an operator for *unpacking assignment*, sometimes
...
A data frame is simply a list of columns, so the *zorcher* assignment does
...
### Class objects
*zorcher* includes implementations of `destructure` for character strings,
